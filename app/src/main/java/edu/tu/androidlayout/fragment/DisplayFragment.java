...
import edu.tu.androidlayout.adapter.StudentAdapter;
...
public class DisplayFragment extends Fragment {
    ...
    private void setRecycleview(){
        ...
        myStudent = new Database(getContext()).getStudentList();
        StudentAdapter adapter = new StudentAdapter(getContext(),myStudent);
